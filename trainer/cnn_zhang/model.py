...
from keras.layers import Input, Embedding, Dense, Dot, Flatten, Convolution1D, ThresholdedReLU, MaxPooling1D, Dropout
...
DENSE_DIM = 1024
EMBEDDING_SIZE = 128
CNN_LAYERS = [[256, 7, 3], [256, 7, 3], [256, 3, -1], [256, 3, -1], [256, 3, -1], [256, 3, 3]]
DROPOUT = 0.2
THRESHOLD = 1e-6
DROPOUT_P = 0.5
