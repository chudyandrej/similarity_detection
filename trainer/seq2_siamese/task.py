...
import trainer.seq2_siamese.model as model
...
def main(data_file, job_dir):
    ...
    input_texts, types = model.load_data(data_file[0])

    model_seq2seq = model.create_model()
    model_seq2seq.compile(optimizer='rmsprop', loss="binary_crossentropy")

    model_seq2seq.fit_generator(model.generate_random_fit(input_texts, types),
