...
import trainer.seq2seq_embedding_l.model as model
...
def main(data_file, job_dir):
    ...
    embedd_model = model.embedding_convert_model()
    os.makedirs(job_dir)
    embedd_model.save(job_dir + "/embedding_model.h5")

    model_seq2seq.compile(optimizer='sgd', loss='mean_squared_error', metrics=['mae', 'acc'])

    model_seq2seq.fit_generator(model.generate_random_fit(input_texts, target_texts, embedd_model),
