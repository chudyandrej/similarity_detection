...
def build_model():
    def value_encodder():
        ...
        encoded_value = Bidirectional(
            CuDNNGRU(units=50, return_sequences=False), merge_mode='concat', weights=None)(embedded_value)
    ...
    quantile_encoder = Bidirectional(CuDNNGRU(units=50, return_sequences=True), merge_mode='concat',
    ...
    joint_model.summary()
    joint_model.name = "join_with_attention"
    return joint_model
