...
class LstmSeq2seqWithGpt2Encoder(Seq2seq):
    def __init__(self, lstm_dim, max_seq_len, version, encoder):
    ...
    def build_model(self):
        ...
        encoder = LSTM(self.lstm_dim, return_state=True, recurrent_dropout=0.4, dropout=0.4)
        encoder_outputs, state_h, state_c = encoder(embedded_encoder_input)

        decoder_gru = LSTM(self.lstm_dim, return_sequences=True, return_state=True, recurrent_dropout=0.4, dropout=0.4)
